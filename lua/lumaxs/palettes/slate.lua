return {
	-- Required
	bg = "#0f1012",
	fg = "#d0d8e8",        -- cinza-fria grau 6 (mais claro)
	keyword = "#b0bcd0",   -- cinza-fria grau 5
	func = "#6a7888",      -- cinza sintático grau 4
	type_ = "#505e6e",     -- cinza sintático grau 3
	string = "#3a82d4",    -- azul forte (substitui o dourado)
	number = "#96c5f8",
	comment = "#384048",   -- cinza grau 1, mais visível que antes (#303840)
	operator = "#96c5f8",
	...
	-- Foregrounds
	fg_muted = "#606878",      -- cinza-fria grau 3
	fg_subtle = "#404858",     -- cinza-fria grau 2
	fg_disabled = "#2e3a48",   -- cinza-fria grau 1
	line_nr = "#2a2e3a",
	line_nr_active = "#8890a0", -- cinza-fria grau 4

	-- Cinder-specific semantic extras
	func_call = "#8a96a8",     -- cinza sintático grau 5 (mais visível que func)
	func_import = "#8ab0c8",   -- mantém (azul-acinzentado, diferenciado)
	comment_doc = "#404e5e",   -- cinza sintático grau 2 (mais visível que antes)
	accent = "#96c5f8",
	accent_dim = "#6aa8e8",    -- : e , (pontuação secundária)
